...
proc create_ipi_design { offsetfile design_name } {
	...
	set adc_controller_0 [ create_bd_cell -type ip -vlnv user.org:user:adc_controller:1.0 adc_controller_0 ]
	...
	# Connect all clock & reset of adc_controller_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins adc_controller_0/S_ADC_AXI_DATA]
	connect_bd_net [get_bd_pins adc_controller_0/s_adc_axi_data_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins adc_controller_0/s_adc_axi_data_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to adc_controller_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/adc_controller_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_adc_controller_0_S_ADC_AXI_DATA_* ]]
	puts $fp "set s_adc_axi_data_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:adc_controller:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/adc_controller_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "adc_controller_v1_0_hw_${i}"
